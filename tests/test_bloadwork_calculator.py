...
def test_calculate_bmi_zero_height():
    ...
    with pytest.raises(ValueError):
        calculate_bmi(70, 0) # Powinno zgłosić błąd dzielenia przez zero    calculate_bmi(70, 0) # Powinno zgłosić błąd dzielenia przez zero
...
def sample_patients():
    ...
    return [{"id": 1, "weight": 70, "height": 175, "sex": "M", "hemoglobin":14.5, "neutrophils": 4.5, "lymphocytes": 2.5},
...
@pytest.mark.parametrize("bmi, expected_category", [
    (16.0, "wychudzenie"), # dokładnie na granicy wygłodzenie/wychudzenie
